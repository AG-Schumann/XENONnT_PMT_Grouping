...
# Constants
PATH = "/data/storage/posrec_hitpatterns"  
FILE_NAME = "fuse_hitpatterns_run_00246.hdf5"
TOTAL_EVENTS = 9995
PMTs_top = 253
...
PATH = "/data/storage/posrec_hitpatterns"
PMTs_top = 253
#Broken_runs = [3, 36, 38, 71, 73, 145, 147, 150, 154, 156, 157, 158, 163, 225, 229,235, 287, 311, 312, 313, 345, 351, 352, 363, 367] 
...
#Broken runs
#3,18,32,51,69,88,105,124,170,171,172,173,174,175,176,177,178,179,190
#191,192,193,194,195,196,197,198,199,239,257,268,272,298,328
...
# Predict the position using the model
predicted_coordinates = model_all.predict(np.expand_dims(test_event, axis=0))[0]
print("True Coordinates (MC):", true_coordinates)
print("Predicted Coordinates:", predicted_coordinates)
